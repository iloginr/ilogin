...
class ILogin(object):
    ...
    cmd:
      ...
      import  Import services from CSV file. CSV file headers
      ...
      passwd  Add new ilogin MASTER password.
              You will still be able to use all previous registered
              MASTER passwords.
              !!! WARNING !!!
    ...
    def login(self, service=None):
        ...
        for _tri in range(self.tries):
            ...
            if not self._login(password):
                print("Master password NOT recognized. "
                      "Please register it first with: ilogin passwd")
                continue
